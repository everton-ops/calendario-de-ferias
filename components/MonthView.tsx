...
import { AREA_COLORS, AREA_TEXT_COLORS, AREA_BG_LIGHT, getDaysInMonth, MONTHS_FULL_PT } from '@/lib/utils'
    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="grid grid-cols-7">
        {cells.map((day, idx) => {
          ...
          const holName = HOLIDAY_NAMES[mmdd]
          ...
          return (
            <div
              ...
              className={`min-h-24 p-1.5 border-b border-r border-gray-100 flex flex-col gap-1 ${
                isHol ? 'bg-red-50' : isWknd ? 'bg-gray-50' : 'bg-white'
              }`}
            >
              ...
              {isHol && holName && (
                <span className="text-xs text-red-500 font-medium leading-tight">{holName}</span>
              )}
